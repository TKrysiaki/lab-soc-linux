...
|-----|------------|-------------|-------|
| [33](./33-soc-sqli-exfiltration-enumeration-detection-response) | Web shell upload + file integrity monitoring (FIM) detection + response validation | Wazuh (FIM/syscheck), Apache (access.log), DVWA | T1190, T1505.003, T1565 |
