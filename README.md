...
|-----|------------|-------------|-------|
| [33](./33-soc-web-shell-fim-detection-response-validation) | Web shell upload + remote command execution (RCE) + investigation + response validation | Wazuh, Apache (access.log), DVWA | T1190, T1505.003, T1059 || [32](./32-soc-dns-tunneling-exfiltration-detection-response-validation) | DNS tunneling + data exfiltration + behavioral detection + egress filtering containment | Suricata (eve.json), tcpdump | T1048.003, T1071.004 |
