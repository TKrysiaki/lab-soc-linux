...
|-----|------------|-------------|-------|
| 30 | [SSH brute force + persistence + log tampering + response validation](./30-soc-ssh-bruteforce-persistence-logtampering-response) | Wazuh, auth.log, auditd, Fail2ban | T1110, T1078, T1098, T1070 |
