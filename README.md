...
|-----|------------|-------------|-------|
| [31](./31-soc-web-shell-rce-detection-investigation-response) | Web shell upload + remote command execution (RCE) + investigation + response validation | Wazuh, Apache, DVWA | T1190, T1505.003, T1059 |
